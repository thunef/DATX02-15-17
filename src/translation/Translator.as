	...
	public static function setLanguageValue(lang:String):void {
		...
		if ('en' == lang) Scratch.app.translationChanged(); // there is no .po file English
			...
			var rader:Array = [
													...
													'msgid\"Max speed(255)\"',			'msgstr\"Maximala hastigheten(255)\"',
													'msgid\"Normal speed(120)\"',			'msgstr\"Normala hastigheten(120)\"',
													'msgid\"Min speed(50)\"',			'msgstr\"Minimala hastigheten(50)\"',
